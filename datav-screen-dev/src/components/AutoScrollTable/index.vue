  ...
  data() {
    return {
      ...
      defaultConfig: {
        ...
        header: [],
        /**
         * @description Board data  表格数据
         * @type {Array<Array>}
         * @default data = []
         */
        data: [],
        /**
         * @description Row num  展示多少行
         * @type {Number}
         * @default rowNum = 5
         */
        rowNum: 5,
         ...
         */
        oddRowBGC: "#003B51", // 奇数行颜色
        /**
         * @description Even row background color
         * @type {String}
         * @default evenRowBGC = '#003B51'  偶数行颜色
         */
        evenRowBGC: "#0A2732",
        /**
         * @description Scroll wait time  等待时间
         * @type {Number}
