                ...
                <div class="list-inner"
                    ...
                    <div class="list">
                        ...
                        <div class="chart-wrapper">
                            ...
                            <div class="chart"
                                 :id="`activate-user-chart${index + 1}`" />
                        </div>
                        <div class="category-wrapper">
                            <country-category :data="['商家', '订单数', '销售额']"
                                              :color="['rgb(178, 209, 126)', 'rgb(116, 166, 49)']" />
                        </div>
                        <div class="scroll-list-wrapper">
                            <auto-scroll-table :config="config[index]"
                ...
                for (let i = 0; i < currentData.length; i++) {
                    ...
                    for (let j = 0; j < shopData.length; j++) {
                        ...
                        for (let k = 0; k < 3; k++) {
                            ...
                            if (k === 2) {
                                data[j].push(
                                    `<div style="color:rgb(178,209,126)">${text}</div>`
                                );
                            } else {
