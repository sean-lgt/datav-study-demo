<template>
    ...
    <!-- <div class="container">
        <loading :width="200"
                 :height="200">数据大屏加载中</loading>
        <div style="width:50%;background:#333;color:#fff">
            <fly-box>
                <div>1111</div>
                <div>22</div>
                <div>12211</div>
...
import FlyBox from "../../components/FlyBox/index.vue";
...
import ScheduleView from "../../components/SceduleView/index.vue";
